...
Type "kzero" in serial mstrInitor and Nybble should move to zero state. 
Then type "m12 -30" to rotate the left elbow. 12 is the joint index. -30 is the rotational angle.
The first number is frame count. For static posture it's 1, for gait is the number of following rows.
The next two numbers are the default body roll/pitch orientation. The next 16 numbers are indexed joint angles (+/-90). 
The angles of head and tail are calculated in real time. 
*/
